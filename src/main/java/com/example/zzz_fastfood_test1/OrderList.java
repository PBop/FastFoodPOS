...
public class OrderList {
     ...
     *
     */
    private ArrayList<String> orderList = new ArrayList<String>(); // String list for items ordered
    private ArrayList<Double> orderPrice = new ArrayList<Double>(); // Double list to store prices of items ordered

   @FXML
   private ListView lvOrderList = new ListView();
    ...
    public void addOrderItem(String item) {
        ...
        for (String items : orderList ){
            lvOrderList.getItems().addAll(items);
        }
        lvOrderList.getSelectionModel().getSelectedItems().toString();
